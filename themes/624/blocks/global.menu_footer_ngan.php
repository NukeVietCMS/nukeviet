...
if (! nv_function_exists('nv_menu_theme_default_footer_ngan')) {
    function nv_menu_theme_default_footer_ngan_config($module, $data_block, $lang_block)
    {
        global $site_mods;
    ...
    function nv_menu_theme_default_footer_ngan_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    /**
     * nv_menu_theme_default_footer_ngan()
     *
     * @param mixed $block_config
     * @return
     *
     */
    function nv_menu_theme_default_footer_ngan($block_config)
    {
        global $global_config, $site_mods, $lang_global;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.menu_footer_ngan.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.menu_footer_ngan.tpl')) {
            $block_theme = $global_config['site_theme'];
        } else {
            $block_theme = 'default';
        }

        $xtpl = new XTemplate('global.menu_footer_ngan.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_menu_theme_default_footer_ngan($block_config);
}
