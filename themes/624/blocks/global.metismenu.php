...
if (! nv_function_exists('nv_menu_bootstrapegov')) {
    ...
    function nv_menu_bootstrapegov($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/global.metismenu.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/global.metismenu.tpl')) {
