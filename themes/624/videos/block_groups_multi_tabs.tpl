...
<!-- BEGIN: group_info -->
  <li id="{BLOCK_INFO.active}" class="{BLOCK_INFO.active}"><a data-toggle="tab" class="dmc"  href="#block-news-groups-{BLOCK_INFO.bid}"><i class=" fa fa-video"></i> {BLOCK_INFO.title}</a></li>
<!-- END: group_info -->
</ul>
