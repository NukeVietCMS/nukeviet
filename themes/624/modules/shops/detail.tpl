...
<div class="product-detail <!-- BEGIN: popupid -->prodetail-popup<!-- END: popupid -->" itemtype="https://schema.org/Product" itemscope>
    ...
    <div class="panel panel-default panel-product-info">
        <div class="panel-body">
            <div class="row">
			<div id="title"><span class="title1"></span><h1 class="info-title title texts chuhoa" itemprop="name">{TITLE}</h1><span class="title2"></span></div>
                ...
                <div class="col-xs-24 col-sm-14 col-md-14">
                    <ul class="product-info">
                        ...
                        <p class="text-justify" itemprop="description" style=" max-height: 165px; overflow: hidden;">{hometext}</p>
                        </li>
                        <!-- END: hometext -->
                        <!-- BEGIN: promotional -->
    ...
    <div role="tabpanel" class="tabs">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <!-- END: tabs_title -->
			<li role="presentation"
                <!-- BEGIN: active -->class="active"<!-- END: active -->> <a href="#{TABS_KEY}-{TABS_lienhe}" aria-controls="{TABS_KEY}-{TABS_lienhe}" role="tab" data-toggle="tab">    <em class="fa fa-bars">
        ...
        <div class="tab-content">
            ...
            <!-- END: tabs_content -->
			<div role="tabpanel" class="tab-pane fade <!-- BEGIN: active -->active in<!-- END: active -->" id="{TABS_KEY}-{TABS_lienhe}">[LIENHESHOP]</div>
	...
	<div id="title"><span class="title1"></span><h3 class="title texts chuhoa" itemprop="headline">{LANG.detail_others}</h3><span class="title2"></span></div>
	...
	<div id="title"><span class="title1"></span><h3 class="title texts chuhoa" itemprop="headline">{LANG.detail_others_view}</h3><span class="title2"></span></div>
