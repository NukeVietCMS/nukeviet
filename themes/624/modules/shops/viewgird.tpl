<!-- BEGIN: main -->
<div class="row viewgrid shops-viewgrid shops-viewgrid-{MODULE_NAME} wow  fadeInDown ">
    <!-- BEGIN: loop -->
    <div class="col-sm-12 col-md-{NUM}">
        <div class="thumbnail wow pulse">
            <div style="height: {HEIGHT}px" class="item-image">
                <a href="{ROW.link_pro}" title="{ROW.title}" rel="dofollow">
			  
				
				<div class=""  <!-- BEGIN: tooltip_js -->data-content='{ROW.hometext}' data-rel="tooltip" data-img="{ROW.homeimgthumb}"<!-- END: tooltip_js -->class="img-thumbnail" style="height: {HEIGHT}px; max-height:{HEIGHT}px; width:100%;max-width:{WIDTH}; background-image: url({ROW.homeimgthumb}); background-repeat: no-repeat;    background-position: center center;    background-size: auto 100% ;"> 
				</div></a> 
            </div>
            <div class="info_pro">
                <!-- BEGIN: new -->
