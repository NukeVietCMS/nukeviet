...
if (! nv_function_exists('nv_menu_bootstrapegov')) {
    ...
    function nv_menu_bootstrapegov($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/global.menuicon.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/global.menuicon.tpl')) {
        ...
        $xtpl = new XTemplate('global.menuicon.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
    ...
    {
        $xtpl = new XTemplate('global.menuicon.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/menu');
