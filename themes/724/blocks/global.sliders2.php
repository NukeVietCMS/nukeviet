...
{
	function nv_block_data_config_sliders2( $module, $data_block, $lang_block )
	{
	...
	function nv_block_data_config_sliders2_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
	...
	function nv_block_global_sliders( $block_config )
	{
		...
		if( ! empty( $array_banners_content ) )
		{
			...
			if( file_exists( NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.sliders2.tpl' ) )
			{
				$block_theme = $global_config['module_theme'];
			}
			elseif( file_exists( NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.sliders2.tpl' ) )
			{
			...
			$xtpl = new XTemplate( 'global.sliders2.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks' );
