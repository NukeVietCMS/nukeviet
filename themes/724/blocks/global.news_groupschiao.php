...
if (! nv_function_exists('nv_block_news_egovgroupschiao')) {
    /**
     * nv_block_config_news_egovgroupschiao()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_news_egovgroupschiao($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_news_egovgroupschiao_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_news_egovgroupschiao_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    /**
     * nv_block_news_egovgroupschiao()
     *
     * @param mixed $block_config
     * @return
     */
    function nv_block_news_egovgroupschiao($block_config)
    {
        global $site_mods;
        ...
        if (isset($site_mods[$module])) {
            ...
            $homewidth = $module_config[$module]['homewidth'];
            $homeheight = $module_config[$module]['homeheight'];
            ...
            if (!empty($list)) {
                if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.news_groupschiao.tpl')) {
                    $block_theme = $global_config['module_theme'];
                } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.news_groupschiao.tpl')) {
                ...
                $xtpl = new XTemplate('global.news_groupschiao.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
                ...
                foreach ($list as $l) {
                    ...
                    $l['homewidth'] = $homewidth;
                    $l['homeheight'] = $homeheight;
                    ...
                    if (! empty($l['thumb'])) {
						...
						$xtpl->assign('IMGHIGHT1', $module_config[$module_name]['homeheight']);
                    }
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_news_egovgroupschiao($block_config);
}
