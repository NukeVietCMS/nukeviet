                        ...
                        if (!empty($value)) {
							...
							elseif (strtolower($key) == 'web') {
                                ...
                                foreach ($ss as $k => $s) {
                                    ...
                                    if ($k) {
                                        $xtpl->parse('main.dep.web.item.comma');
                                    }
                                    $xtpl->parse('main.dep.web.item');
                                }
                                $xtpl->parse('main.dep.web');
                            } 
							
							elseif (strtolower($key) == 'bando') {
                                $ss = array_map('trim', explode(',', $value));
                                foreach ($ss as $k => $s) {
                                    $xtpl->assign('BANDO', [
                                        'name' => $key,
                                    ...
                                    if ($k) {
                                        $xtpl->parse('main.dep.bando.item.comma');
                                    }
                                    $xtpl->parse('main.dep.bando.item');
                                }
                                $xtpl->parse('main.dep.bando');
                            } 
