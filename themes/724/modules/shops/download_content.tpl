...
<div class="download_content">
	...
	<div class="row download">
		<div class="col-md-18">
			<img src="{FILES.extension_icon}" width="16" />&nbsp;<a target="_blank" href="" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{FILES.description}">{FILES.title}</a>
		</div>
