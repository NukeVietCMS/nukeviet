...
<div class="panel panel-default">
    <div class="panel-body">
		...
		<div class="khung p5 m05">
        <h3 class="chuhoa  textc">
            <a title="{TITLEROW}" href="{LINK}">{TITLEROW}</a>
        </h3>
        <div class="text-justify">
            <p>
                <!-- BEGIN: result_img --><a title="{LANG.cart_check_out} {TITLEROW}"  href="{LINK}">
                <img src="{IMG_SRC}" width="100px" class="img-thumbnail pull-left image p5 m10" /></a>
                <!-- END: result_img -->
                {CONTENT} <a title="{LANG.cart_check_out} {TITLEROW}"  href="{LINK}">{LANG.cart_check_out}</a>
            </p>
        </div>
        <!-- BEGIN: adminlink -->
